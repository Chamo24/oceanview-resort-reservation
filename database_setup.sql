...
('admin', 'admin123', 'System Administrator', 
    'admin', 0),
('reception1', 'rec123', 'Nimal Perera', 
    'receptionist', 0);
...
('102','Single',5000.00,'Available',
    'Standard single room with garden view'),
('103','Single',5500.00,'Available',
    'Single room with partial sea view'),
('201','Double',8000.00,'Available',
    'Spacious double room with sea view'),
('202','Double',8000.00,'Available',
    'Spacious double room with sea view'),
('203','Double',8500.00,'Available',
    'Double room with balcony and sea view'),
('301','Deluxe',12000.00,'Available',
    'Deluxe room with panoramic ocean view'),
('302','Deluxe',12000.00,'Available',
    'Deluxe room with private balcony'),
('401','Suite',20000.00,'Available',
    'Luxury suite with living area and ocean view'),
('402','Suite',25000.00,'Available',
    'Presidential suite with jacuzzi and terrace');
...
VALUES ('OVR-2025-0001', 'Kamal Silva',
    '45 Galle Road, Colombo', '0771234567',
    'kamal@example.com', 4, 'Double',
    '2025-07-15', '2025-07-18', 1);